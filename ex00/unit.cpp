...
unit::unit(void)
	: _index(++unit::index),_name("Watson"), _type("Unit"), _x(0), _y(0), _damage(0), _hp(0), _maxHp(0), _die(false)
{
	print_created();
}
...
{   
	//std::cout << u.getName() << " is a " << u.getType() << std::endl;
	//Joe is a Marine in 13/45 with 40/40HP damaging at 6
